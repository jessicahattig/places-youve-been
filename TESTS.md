...
Test: "It should delete destinations per their Id's without altering the number of Id's"
Code: destinationsList.deleteDestination(2);
Expected Output: currentId: 3;
                 destinations: Object { 1: {...}, 3: {...} }